...
void test_func(double *x, double *f, int nx, int mx,int func_num)
{
	...
	if (ini_flag==0)
	{
		...
		sprintf(FileName, "cec2013single_master/cec2013single/cec2013_data/M_D%d.txt", nx);
		...
		fpt=fopen("cec2013single_master/cec2013single/cec2013_data/shift_data.txt","r");
		if (fpt==NULL)
		{
